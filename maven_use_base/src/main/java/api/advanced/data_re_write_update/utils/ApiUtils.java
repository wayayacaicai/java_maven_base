 ...
 * 
 */
package api.advanced.data_re_write_update.utils;
...
import api.advanced.data_re_write_update.pojo.ApiInfo;
import api.advanced.data_re_write_update.pojo.CellData;
import api.advanced.data_re_write_update.testcase.AllTestCase;
...
public class ApiUtils {
	//收集响应数据的列表
	private static List<CellData> allDatas = new ArrayList<>();
	...
	public static List<CellData> getAllDatas() {
		return allDatas;
	}

	public static void addData(CellData cellData) {
		allDatas.add(cellData);
	}
