...
public class DataProviderUtils {
	public static Object[][] getDatas() {
		// 接口基本信息
		List<ApiInfo> datasInfoList = (List<ApiInfo>) ExcelUtils.readExcel("/excel/reflect/excelReflect.xlsx", 0, ApiInfo.class);
		// 接口详细信息
		List<ApiCaseDetail> datasDetailList = (List<ApiCaseDetail>) ExcelUtils.readExcel("/excel/reflect/excelReflect.xlsx", 1,
				ApiCaseDetail.class);
		// ApiId的容器转换
