...
import base08.pojo.ApiInfo;
import base08.pojo.BaseExcelSheet;
import base08.pojo.CellData;
import base08.pojo.SqlChecker;
...
public class DataProviderUtils {
	...
	public static Object[][] getDatas(){
		List<ApiInfo> apiInfoList = (List<ApiInfo>) ExcelUtils.readExcel("/base08/testcase1.xlsx", 0, ApiInfo.class);
		List<ApiCaseDetail> apiCaseDetailList = (List<ApiCaseDetail>) ExcelUtils.readExcel("/base08/testcase1.xlsx", 1, ApiCaseDetail.class);
		List<SqlChecker> sqlCheckerList = (List<SqlChecker>) ExcelUtils.readExcel("/base08/testcase1.xlsx", 2, SqlChecker.class);
