...
import base09.pojo.ApiInfo;
import base09.pojo.BaseExcelSheet;
import base09.pojo.CellData;
import base09.pojo.SqlChecker;
...
public class DataProviderUtils {
	...
	public static Object[][] getDatas(){
		List<ApiInfo> apiInfoList = (List<ApiInfo>) ExcelUtils.readExcel("/base09/testcase.xlsx", 0, ApiInfo.class);
		List<ApiCaseDetail> apiCaseDetailList = (List<ApiCaseDetail>) ExcelUtils.readExcel("/base09/testcase.xlsx", 1, ApiCaseDetail.class);
		List<SqlChecker> sqlCheckerList = (List<SqlChecker>) ExcelUtils.readExcel("/base09/testcase.xlsx", 2, SqlChecker.class);
