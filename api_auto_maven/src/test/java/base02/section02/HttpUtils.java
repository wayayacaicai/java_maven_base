...
/**
 * @Desc:请求工具类(防止api的侵入，后期只用调整工具类其中的参数即可)
 * @author:zpp 
 * @time:2019年5月20日 下午5:13:52
 */
public class HttpUtils {
	public static String get(String baseUrl,HashMap<String, String> hmParams) {
		...
		try {
			...
			if(hmParams !=null){
				...
				Set<Entry<String, String>> entrySet = hmParams.entrySet();
	...
	public static String post(String baseUrl, HashMap<String, String> hmParams) {
		String entityStr = null;
