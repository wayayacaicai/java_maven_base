...
/**
 * @Desc:数据提供者--基本post请求升级版
 * @author:zpp 
 * @time:2019年5月20日 下午5:13:27
 */
public class HttpPostTest {
	...
	public void post(String mobilephone,String pwd,String expectedResult){
		try {
			...
			postEntity.add(new BasicNameValuePair("mobilephone", mobilephone));
			postEntity.add(new BasicNameValuePair("pwd", pwd));
