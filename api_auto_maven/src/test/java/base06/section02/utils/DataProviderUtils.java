...
import base06.section02.pojo.ApiInfo;
...
public class DataProviderUtils {
	...
	public static Object[][] getDatas(){
		List<ApiCaseDetail> apiCaseDetailList = (List<ApiCaseDetail>) ExcelUtils.readExcel("/base06/testcase2.xlsx", 1, ApiCaseDetail.class);
		List<ApiInfo> apiInfoList = (List<ApiInfo>) ExcelUtils.readExcel("/base06/testcase2.xlsx", 0, ApiInfo.class);
