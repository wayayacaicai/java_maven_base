...
import base07.pojo.ApiInfo;
import base07.pojo.BaseExcelSheet;
...
public class DataProviderUtils {
	...
	public static Object[][] getDatas(){
		List<ApiInfo> apiInfoList = (List<ApiInfo>) ExcelUtils.readExcel("/base07/testcase.xlsx", 0, ApiInfo.class);
		List<ApiCaseDetail> apiCaseDetailList = (List<ApiCaseDetail>) ExcelUtils.readExcel("/base07/testcase.xlsx", 1, ApiCaseDetail.class);
		List<SqlChecker> sqlCheckerList = (List<SqlChecker>) ExcelUtils.readExcel("/base07/testcase.xlsx", 2, SqlChecker.class);
