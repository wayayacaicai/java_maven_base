...
public class DataProviderUtil {
	...
	public static Object[][] getData(String caseName, Class<RegisterInfo> class1) {
		...
		////base08/testcase/register/register.xlsx
		String excelPath = "/base08/testcase/"+excelName+"/"+excelName+".xlsx";
		
		List<? extends ExcelSheetObject> registerInfoList = ExcelUtils.readExcel(excelPath, sheetName, class1);
		//创建一个二维数组
		Object[][] datas = new Object[registerInfoList.size()][];
		for (int i = 0; i < registerInfoList.size(); i++) {
			ExcelSheetObject registerInfo = registerInfoList.get(i);
